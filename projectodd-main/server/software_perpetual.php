...
<head>
    ...
    <title>Moment-Software Perpetual</title>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse show" id="collapseSoftware" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link active" href="software_perpetual.php">Perpetual</a>
                            </nav>
                        </div>
                        <?php if ($role === 'admin'): ?>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Software Perpetual</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <div>
                                    <a href="export_software_perpetual.php" class="btn btn-success">
                                ...
                                <form action="process_software.php" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" name="lokasi" value="Perpetual">
                                        </div>
                                    </div>
