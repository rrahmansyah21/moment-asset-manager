                    ...
                    <div class="nav">
                        ...
                        <div class="collapse show" id="collapseRack" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link active" href="rack_drc.php">DRC</a>
                            </nav>
                        </div>
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="rack-container">
                                <?php
                                // Hanya ambil rack dari lokasi DRC
                                $sql = "SELECT DISTINCT rack FROM hardware WHERE lokasi='DRC' AND rack IS NOT NULL AND rack != ''";
                                ...
                                foreach ($racks as $rack) {
                                    ...
                                    // Hanya ambil hardware dari lokasi DRC
                                    $sql = "SELECT nama_perangkat, u_position, u_height 
                                            FROM hardware 
                                            WHERE lokasi='DRC' AND rack='$rack' 
